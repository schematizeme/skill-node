...
> `references/entrega.md`. Leia lá primeiro; aqui fica **só o que muda em Node/TypeScript**.
>
...
>
> **Onde está agora:** `references/stack-versoes.md` desta skill (versões de Node/TypeScript e do
