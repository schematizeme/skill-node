...
gerado por IA. O gate `/node-review` (DoD) reprova o que violar isto — **em modo escopo-diff** (ver §0).

## 0. Regra escoteiro (escopo-diff + baseline) — específico de legado

Este é **código legado**: não se traz o repositório inteiro ao padrão num PR de fix. Portanto **todos os pisos deste arquivo** (300 linhas, uma função/arquivo, doc-comment, MAPA/índice) valem para:
