...
2. Some a isso a análise que o script NÃO faz bem sozinho:
   ...
   - **Escopo-diff:** os pisos de qualidade (300 linhas, doc, TS strict, `any`) valem para arquivo novo e trecho tocado; **não** reprove dívida pré-existente que não veio no diff (regra escoteiro, `references/padroes-codigo.md` §0).
