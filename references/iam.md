...
- **Nunca menos de 2 fatores:** após o bootstrap, **acesso pleno/sensível fica bloqueado
  até enrolar um 2º fator forte**. Como o legado tem só 1 fator, a migração **força o
  enrolamento do 2º fator no 1º login pós-corte** (§7).

## 4. Fluxos

**Onboarding:** cita um email → **verifica** → **escolhe o 1º meio de autenticação** →
passa → **escolhe o 2º meio** (fator forte) → passa → **acesso**. O 2º fator é obrigatório.
...
4. **Força o 2º fator no 1º login pós-migração.** Como o legado tem 1 fator, o acesso pleno
   fica **bloqueado até enrolar um fator forte** (passkey/TOTP) — enrolamento forçado.
...
- **F3** Força 2º fator no 1º login; revoga sessões legadas; risk engine.
...
- [ ] **≥ 2 fatores** no alvo; **2º fator forçado no 1º login pós-migração**; passkey no núcleo; email OTP (Resend) always-on; Twilio p/ telefone.
