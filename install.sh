...
# Como funciona: copia o corpo da skill para .claude/skills/schematize-node/ e instala os
...
# Saída: .claude/skills/schematize-node/ e .claude/commands/<slug>-*.md no alvo.
set -euo pipefail
